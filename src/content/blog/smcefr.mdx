...
<MyFigure src="/assets/smcefr.webp" id="smcefr-18" alt="" caption="Figure 1: A sample of 18 images from the <code>smcefr-mini</code> dataset" />
...
<MyFigure src="/assets/smcefr-filename.webp" id="sen3-fname" alt="" caption="Figure 2: Sentinel-3 Generic Filename Schema Image" />
